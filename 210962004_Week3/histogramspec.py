...
inp_img = cv2.imread('Resources/inp_image.webp', 0)
ref_img = cv2.imread('Resources/ref_image.webp', 0)

new_img = histogram_specification(inp_img, ref_img)
cv2.imwrite('Resources/transformed_image.jpg', new_img)
...
plt.savefig('Resources/histogram_specification.png')
plt.show()
